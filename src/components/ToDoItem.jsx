...
export default function ToDoItem() {
  return (
    <div className="w-full bg-gray-200 p-3 rounded-2xl shadow-2xl flex flex-wrap items-center gap-3">
      ...
      {/* Tick Icon */}
      <div className="bg-purple-500 w-[30px] h-[30px] rounded-full text-white flex justify-center items-center text-2xl flex-shrink-0">
        <TiTick />
      </div>

      {/* Text */}
      <p className="flex-1 min-w-[150px] break-words whitespace-pre-wrap overflow-hidden text-sm sm:text-base">
        ddfg
      </p>
